...
class SentiFeature(data.Dataset):
    ...
    def get_data(self, index):
        ...
        if self.modal == 'all':
            ...
            feature = [jittor.array(rgb_feature), jittor.array(mfcc_feature)]
            ...
            return jittor.array(feature), vid_num_seg, sample_idx
    ...
    def get_label(self, index, vid_num_seg, sample_idx):
        ...
        if self.supervision == 'video':
            return jittor.array(label), jittor.array(0)
            ...
            point_label = jittor.array(temp_anno[sample_idx, :])

            return jittor.array(label), point_label, jittor.array(label_distribution)
